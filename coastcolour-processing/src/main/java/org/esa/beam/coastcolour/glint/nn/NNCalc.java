 ...
 * {@link org.esa.beam.coastcolour.glint.nn.NNffbpAlphaTabFast#calcJacobi(double[])} method.
 *
 * @author K. Schiller
 *         Copyright GKSS/KOF
...
public class NNCalc {
    /**
     * The vector containing the output of a {@link org.esa.beam.coastcolour.glint.nn.NNffbpAlphaTabFast}.
     */
