...
# coastcolour-bin-1.6-SNAPSHOT-stitching-call.bash hdfs://master00:9000/calvalus/projects/cc/l1p-nc/greatbarrierreef/2005/MER_FSG_CCL1P_20050614_001256_000001912038_00102_17190_0001.nc.gz hdfs://master00:9000/calvalus/projects/cc/test
set -e
set -m
...
then
    ...
    gunzip in/*gz
    mkdir out
    /home/hadoop/opt/coastcolour/coastcolour-bin-1.6-SNAPSHOT/bin/cc_stitcher.sh in/*.nc -o out
    gzip out/*.nc
